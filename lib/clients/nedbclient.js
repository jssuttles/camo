...
var createCollection = function(collectionName, url, options) {
	options = options || {};
	if (url === 'memory') {
	...
	Object.assign(options, {filename: collectionPath, autoload: true});
	return new Datastore(options);
};

var getCollection = function(name, collections, path, options) {
	if (!(name in collections)) {
		var collection = createCollection(name, path, options);
...
class NeDbClient extends DatabaseClient {
	...
	save(collection, id, values) {
		...
		return new Promise(function(resolve, reject) {
			var db = getCollection(collection, that._collections, that._path, that._options);
    ...
    createIndex(collection, field, options) {
        ...
        var db = getCollection(collection, this._collections, this._path, this._options);
